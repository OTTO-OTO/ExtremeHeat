...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            params = {
                ...
                "cx": "006684083430066475722:qvk7zd6drmk",
                "q": f"{keyword}",
                "safe": "off",
                "cse_tok": "AB-tC_7jb4DGV-3-MAlG85iSnQUQ:1740126067606",
                "lr": "",
                "cr": "",
                "gl": "",
                "filter": "1",
                ...
                "as_sitesearch": "",
                "exp": "cc",
                "callback": "google.search.cse.api14839",
                "rurl": "http://agenda.ge/"
            }
    ...
    def parse_url(self, request, response):
        ...
        # print(response.text)
        # print(response)
        links = json.loads(response.text.split("api14839(")[-1].split(");")[0])["results"]
        # print(links)
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='col col-12 node-content']//p/text()").extract())
        items.author = ''
        items.pubtime = response.xpath("//div[@class='node-publish-date']/text()").extract_first()
        print(items)
        # if items.content:
        #     yield items
