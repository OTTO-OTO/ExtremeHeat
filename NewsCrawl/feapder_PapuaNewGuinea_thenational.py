...
class AirSpiderDemo(feapder.AirSpider):
    ...
    table = 'PapuaNewGuinea_thenational'
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.thenational.com.pg/?s=Extreme+heatwave",
        ...
        request.cookies = {
            ...
            "__cf_bm": "iZ8zC8sVFINv6TEkqq6WLZWPaD30zl5hPvRjbfuEdJc-1736384248-1.0.1.1-7MvTCcnIjf4NX0G65LL3K5yI09a5CUjuV3KiFLomyY_mSOa2QcQmBLV1AkW6LbQFAm.jVy2qQeQb3FbwpQ_R9g",
            "_ga_9JVCGQ7L3H": "GS1.1.1736384259.7.1.1736384677.0.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='tdb_module_loop td_module_wrap td-animation-stack td-cpt-post']//h3/a/@href").extract()
