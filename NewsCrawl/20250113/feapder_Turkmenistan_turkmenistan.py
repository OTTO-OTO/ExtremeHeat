...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def download_midware(self, request):
        ...
        request.cookies = {
            "_ga": "GA1.1.960086860.1736735276",
            "_ga_1W7LZSXQVM": "GS1.1.1736735275.1.1.1736735435.0.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//a[@id='urlnews']/@href").extract()
        # print(links)
    ...
    def parse_detail(self, request, response):
        ...
        content = "".join(response.xpath("//div[@class='post_text']//p/text()").extract())
