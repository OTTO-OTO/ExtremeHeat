...
class AirSpiderDemo(feapder.AirSpider):
    ...
    country = 'Tonga'
    table = 'Tonga_matangitonga'
    keywords = [
                 "Extreme temperature", "Heatwave event",
                ...
                "Extreme rainfall", "Drought",  "Long-term drought", "Water shortage", "Power outage",
                ...
                "Heat pollution", "Coral bleaching",
                ]

    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = f"https://matangitonga.to/search/site/{keyword}"
            params = {
                "page": "0"
            }
    ...
    def download_midware(self, request):
        ...
        request.cookies = {
            "_gid": "GA1.2.582866941.1736732895",
            "__eoi": "ID=8b662a8bf9cebdd0:T=1736732885:RT=1736732885:S=AA-AfjbkrILylMAYta5Wbtnw4Z3Q",
            "_ga_H2T1B1N01K": "GS1.1.1736732894.1.1.1736732943.0.0.0",
            "_ga": "GA1.2.1831288596.1736732895"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://matangitonga.to/search/site/{current_keyword}"
        params = {
            "page": f"{current_page}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        content = "".join(response.xpath("//div[@class='field__item even']//text()").extract())
