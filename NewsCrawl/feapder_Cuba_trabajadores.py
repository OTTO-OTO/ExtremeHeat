...
class AirSpiderDemo(feapder.AirSpider):
    ...
    # ]
    keywords = [ 'Calor', 'Lluvia Intensa', 'Sequía',
        'Corte de Energía por Calor','Contaminación del Aire',
        'Reducción de la Producción Agrícola', 'Deficiencia de Oxígeno',
        'Golpe de Calor', 'Calor Afectando el Tráfico', 'Desastre Ecológico',
        'Cambio Climático Afectando la Economía', 'Ola de Calor Marina',
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = f"https://www.trabajadores.cu/search/{keyword}/page/1/"
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://www.trabajadores.cu/search/{current_keyword}/page/{current_page}/"
