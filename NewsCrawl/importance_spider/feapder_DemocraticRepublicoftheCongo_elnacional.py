...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            page = 0
            # 尝试不同的搜索URL结构
            url = "https://elnacional.com.do/buscador-elnacional/"
            ...
            headers = {
                ...
                "priority": "u=0, i",
                "referer": "https://elnacional.com.do/",
    ...
    def download_midware(self, request):
        ...
        request.headers = {
            ...
            "accept-language": "zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6",
            "priority": "u=1, i",
            "referer": "https://elnacional.com.do/buscador-elnacional/",
            "sec-ch-ua": f"\"Microsoft Edge\";v=\"{random.randint(130, 135)}\", \"Chromium\";v=\"{random.randint(130, 135)}\", \"Not_A Brand\";v=\"24\"",
            "sec-ch-ua-mobile": "?0",
            "sec-ch-ua-platform": "\"Windows\"",
    ...
    def parse_url(self, request, response):
        ...
        try:
            ...
            # 尝试多种XPath选择器
            xpath_selectors = [
                "//h2[@class='utf_post_title title-large']/a/@href",
                "//h2/a/@href",
                "//h3/a/@href",
                "//article/a/@href",
            ...
            for link in links:
                if link.startswith('http'):
                    # 只保留来自 elnacional.com.do 的链接
                    if 'elnacional.com.do' in link:
                        valid_links.append(link)
                elif link.startswith('/'):
                    full_url = 'https://elnacional.com.do' + link
        ...
        url = f"https://elnacional.com.do/page/{current_page}/"
        ...
        headers = {
            ...
            "accept-language": "zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6",
            "priority": "u=0, i",
            "referer": f"https://elnacional.com.do/page/{current_page-1}/",
            "sec-ch-ua": f"\"Microsoft Edge\";v=\"{random.randint(130, 135)}\", \"Chromium\";v=\"{random.randint(130, 135)}\", \"Not_A Brand\";v=\"24\"",
            "sec-ch-ua-mobile": "?0",
            "sec-ch-ua-platform": "\"Windows\"",
            "sec-fetch-dest": "document",
