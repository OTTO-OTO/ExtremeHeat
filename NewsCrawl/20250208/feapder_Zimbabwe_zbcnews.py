...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.zbcnews.co.zw/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.zbcnews.co.zw/?s=heavy+rain",
        ...
        request.cookies = {
            "_ga": "GA1.1.53397143.1738994316",
            "cf_clearance": "NHpqxlG9w9XAUScfblD271mc0fCmrwVKi5eW2ScsLwo-1738994309-1.2.1.1-0753Y_d4BR6LZAZtOIvyu2z_iPZwGEqXeUnb4PtGLgPBc7P.EkfFNkWxlVRVsywciB8zd9VZv_3p42gNZ_Q.6L7dsZNK9FGd1Kvm5PUXU.6c7tdWR73E8kHn.Zl9KSdWhr.Vf1Cg9DLzn1K7cYFHmTtzZSGLVbvu9gy9DRORPDCWL7w4nRE0MJzT34aY4CUWStf.89cO8FYDkhQ66eoB.Fft0.0IYIXj9URfuz9tHq2Yywcc2wMzfvAl_EgaBxoRx11bGyVkgAQCfF8_1UKnMXcd7BPDDxrPAs8WDIcA.n8",
            "smcx_458738397_last_shown_at": "1738994331666",
            "_ga_7G8MRHXECG": "GS1.1.1738994316.1.1.1738994372.0.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        # print(response.text)
        links = response.xpath("//div[@id='tdi_116']//h3/a/@href").extract()
        # print(links)
        ...
        url = f"https://www.zbcnews.co.zw/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
