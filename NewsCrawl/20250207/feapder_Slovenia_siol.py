...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath(
            "//ul[@class='search_page__article_list js_searchArticles']/li//article/a/@href").extract()
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='article_content__inline_elements']//p/text()").extract())
        items.author = ''
