...
class AirSpiderDemo(feapder.AirSpider):
    ...
    #蒙古语
    keywords = [
    "Tropical cyclone", "Tropical depression", "Tropical storm", "Typhoon", "Hurricane",
    "Cyclone", "Storm", "Heavy rain", "Flood", "Storm surge", "Coastal disaster",
    "Landslide", "Geological disaster", "Marine disaster", "Strong wind", "Typhoon disaster",
    "Mudslide", "Landslide"
]
    def start_requests(self):
        for keyword in self.keywords:
            ...
            params = {
                ...
                "cx": "009474402686978396678:8m9lvek2a-m",
                "q": f"{keyword}",
                "safe": "off",
                "cse_tok": "AB-tC_50p1BMbGRGYsUclZ9C7sOn:1739603139047",
                "sort": "",
                "exp": "cc,apo",
                "callback": "google.search.cse.api14111",
                "rurl": f"https://ikon.mn/search?q={keyword}"
            }
    ...
    def parse_url(self, request, response):
        ...
        links = json.loads(response.text.split("api14111(")[-1].split(");")[0])["results"]
        ...
        params = {
            ...
            "exp": "cc,apo",
            "callback": "google.search.cse.api14111",
            "rurl": f"https://ikon.mn/search?q={current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='icontent']//p/text()").extract())
        items.author = ''
