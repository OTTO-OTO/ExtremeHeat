...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Marshall_Islands' and language = '英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://marshallislandsjournal.com/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://marshallislandsjournal.com/?s=hot",
        ...
        request.cookies = {
            "_tccl_visitor": "3c404b9a-456d-4691-8fc7-d9b6d251c422",
            "_tccl_visit": "3c404b9a-456d-4691-8fc7-d9b6d251c422",
            "_scc_session": "pc=3&C_TOUCH=2025-04-10T00:41:32.370Z"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://marshallislandsjournal.com/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
