...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = "https://icelandmonitor.mbl.is/news/search/"
            params = {
                "qs": f"{keyword}",
                "offset": "20000",
                "limit": "20",
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='maintext noncleared-maintext bigimgs-interleaved']//p/text()").extract())
        items.author = ''
