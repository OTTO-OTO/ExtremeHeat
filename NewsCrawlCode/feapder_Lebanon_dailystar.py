...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://dailystar.com.lb/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//h2[@class='post-box-title']/a/@href").extract()
        if not links:
        ...
        url = f"https://dailystar.com.lb/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
