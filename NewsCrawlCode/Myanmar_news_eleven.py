...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Myanmar' and language = '英语'"""
    ...
    def parse_url(self, request, response):
        ...
        params = {
            ...
            "field_author_name_value": "",
            "field_custom_post_date_value[Bmin%5D%5Bdate]": "",
            "field_custom_post_date_value[Bmax%5D%5Bdate]": "",
            "page": f"{current_page}"
        }
