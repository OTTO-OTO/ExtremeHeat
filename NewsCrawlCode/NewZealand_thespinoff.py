...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='New_Zealand' and language = '英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://thespinoff.co.nz/api/search"
            params = {
                "offset": "1",
                "q": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=1, i",
            "referer": "https://thespinoff.co.nz/search?q=heavy%20rain",
    ...
    def parse_url(self, request, response):
        ...
        for item in links:
            ...
            items.article_url = "https://thespinoff.co.nz/" + item.get("type") + "/" + datetime.strptime(
                item.get("date"),
