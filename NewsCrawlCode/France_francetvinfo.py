...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='p-article__body']//p//text()").extract()) if response.xpath(
            "//div[@class='p-article__body']//p//text()").extract() else "".join(response.xpath(
            "//div[contains(@class, 'c-body') or contains(@class, 'c-chapo')]//p/text()").extract())  # //div[@class='p-article__body']//p//text()  //div[@class='c-body']//p/text()
        items.author = ''
