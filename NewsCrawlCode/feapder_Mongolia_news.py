...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://news.mn/en/?s=heavy+rain",
        ...
        request.cookies = {
            "_gid": "GA1.2.2133293831.1738806233",
            "w3tc_referrer": "https%3A%2F%2Fnews.mn%2F",
            "_gat_gtag_UA_93023839_1": "1",
            "_ga_6H827N9YB9": "GS1.1.1738806232.1.1.1738806334.50.0.0",
            "_ga": "GA1.1.1589692180.1738806232"
        }
        return request
