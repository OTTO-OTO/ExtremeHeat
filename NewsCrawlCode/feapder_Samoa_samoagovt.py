...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.samoagovt.ws/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.samoagovt.ws/?s=heavy+rain",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='search-post-title']/a/@href").extract()
        ...
        url = f"https://www.samoagovt.ws/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='article_content clearfix entry-content']//p/text()").extract())
        items.author = response.xpath("//meta[@itemprop='author']/@content").extract_first()
