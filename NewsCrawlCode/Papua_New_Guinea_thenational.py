...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Papua_New_Guinea' and language = '英语'"""
    ...
    def start_requests(self):
        ...
        for keyword in self.keywords:
            page = 1
            url = "https://www.thenational.com.pg/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.thenational.com.pg/?s=heat",
        ...
        request.cookies = {
            "_ga": "GA1.1.1908285191.1735182983",
            "__cf_bm": "RhUAg9A95G5b4DxVRfrA374LkfMRK3d7zfGn9FpzHYQ-1736237415-1.0.1.1-C1bdLRFEEalPDHTjQ3yR1B7390m6m37WJpU_5CwXEfUW_noxtCB6JFk2Psx_CDba2cdORlLZZEOUYmwWIwfGpA",
            "_ga_9JVCGQ7L3H": "GS1.1.1736237436.5.1.1736237585.0.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath(
            "//div[@class='tdb_module_loop td_module_wrap td-animation-stack td-cpt-post']//h3/a/@href").extract()
