...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.jeuneafrique.com/personnalites/othman-benjelloun/",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='search-result__list-articles']//h4/a/@href").extract()
        print(links)
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("""//div[@data-mrf-recirculation="Corps d'article"]//p/text()""").extract()).strip()
        items.author = ''
        items.pubtime = response.xpath("//span[@class='relative']/text()").extract_first()
        print(items)
        if items.content:
            yield items
