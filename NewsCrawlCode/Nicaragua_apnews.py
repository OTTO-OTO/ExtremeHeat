...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Nicaragua' and language = '英语'"""
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://japannews.yomiuri.co.jp/?s=heavy+rain",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='PageList-items']//a[@class='Link']/@href").extract()
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath(
                "//div[@class='RichTextStoryBody RichTextBody']//p/text()").extract())
        items.author = ''
