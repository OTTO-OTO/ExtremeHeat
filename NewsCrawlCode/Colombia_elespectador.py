...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            params = {
                "query": '{"author":null,"date":null,"from":10,"keyword":"Temperatura-extrema","section":null,"size":10,"subtype":null}',
                "d": "1017",
    ...
    def parse_url(self, request, response):
        ...
        url = "https://www.elespectador.com/pf/api/v3/content/fetch/searcherTag"
        params = {
            "query": f'{{"author":null,"date":null,"from":{current_page},"keyword":"{current_keyword}","section":null,"size":10,"subtype":null}}',
            "d": "1007",
            "_website": "el-espectador"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//p[@class='font--secondary']/text()").extract())
        items.author = ''
        items.pubtime = response.xpath("//meta[@name='cXenseParse:publishtime']/@content").extract_first()
        print(items)
        if items.content:
            yield items
