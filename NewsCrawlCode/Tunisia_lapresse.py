...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Tunisia' and language='法语'"""
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://lapresse.tn/?s=Temp%C3%A9rature+%C3%A9lev%C3%A9e",
        ...
        request.cookies = {
            "_ga": "GA1.1.457840498.1738976127",
            "__utma": "247591706.457840498.1738976127.1738976128.1738976128.1",
            "__utmc": "247591706",
            "__utmz": "247591706.1738976128.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)",
            "__utmt": "1",
            "_ga_G6SPW1XD26": "GS1.1.1738976127.1.1.1738976249.16.0.1740698968",
            "__utmb": "247591706.5.10.1738976128"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='bdaia-blocks-container']//h2/a/@href").extract()
        # print(links)
        ...
        url = f"https://lapresse.tn/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='bdaia-post-content']//p//text()").extract())
        items.author = ''
