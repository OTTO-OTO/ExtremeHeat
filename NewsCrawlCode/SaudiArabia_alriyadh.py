...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Saudi_Arabia' and language = '阿拉伯语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = "https://www.alriyadh.com/search/srch"
            params = {
                "q": f"{keyword}",
                "sort": "date",
                "page": "0"
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.alriyadh.com/search/srch?q=%D8%AD%D8%B1%D8%A7%D8%B1%D9%87%20%D8%B9%D8%A7%D9%84%D9%8A%D9%87&sort=date&page=10",
        ...
        request.cookies = {
            "_ga": "GA1.2.2034383522.1738894585",
            "_gid": "GA1.2.1032963761.1738894585",
            "_gat": "1",
            "_ga_DFFZB63SRS": "GS1.2.1738894586.1.1.1738894945.0.0.0"
        }
        return request
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath(
                "//div[@class='col-md-12 article-text']//p/text()").extract())
        items.author = ''
