...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://diariorombe.es/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://diariorombe.es/?s=calor",
        ...
        request.cookies = {
            "paddos_566zh": "1",
            "_ga": "GA1.1.863863473.1737085295",
            "__stripe_mid": "d8e99643-e3ce-4079-a913-8b409d83b6d2de18e7",
            "__stripe_sid": "469d60c2-3536-491d-a979-8ee6f862cc4b6aa64c",
            "_ga_ZYQ3X76JP9": "GS1.1.1737085295.1.1.1737085337.0.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://diariorombe.es/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='elementor-widget-container']//p/text()").extract()).strip()
        items.author = ''
