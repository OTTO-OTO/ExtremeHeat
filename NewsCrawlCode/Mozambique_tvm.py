...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = "https://www.tvm.co.mz/index.php/component/search/"
            params = {
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//dt[@class='result-title']/a/@href").extract()
    ...
    def parse_detail(self, request, response):
        ...
        items.author = ''
        items.pubtime = response.xpath("//span[@class='itemDateCreated']/text()").extract_first()
        print(items)
        if items.content:
            yield items
