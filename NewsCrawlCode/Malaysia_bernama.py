...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Malaysia' and language = '英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.bernama.com/en/search.php"
            params = {
                "cat1": "",
                "terms": f"{keyword}",
                "page": "1"
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='col-12 mt-3 text-dark text-justify']//p/text()").extract())
