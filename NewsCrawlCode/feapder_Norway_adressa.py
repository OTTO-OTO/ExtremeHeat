...
class AirSpiderDemo(feapder.AirSpider):
    ...
    table = 'Norway'
    #冰岛语
    keywords = ["Syklon i tropene", "Tropisk depresjon", "Tropisk storm", "Tyfon", "Orkan", "Syklon", "Storm",
                "Kraftig regn", "Flom", "Sjøsprøyt", "Kystskade", "Skred", "Geologisk katastrofe", "Maritim katastrofe",
                "Kraftige vinder", "Tyfonkatastrofe", "Jordskred", "Landskred"]
