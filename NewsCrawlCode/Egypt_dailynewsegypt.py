...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Egypt' and language='英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.dailynewsegypt.com/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.dailynewsegypt.com/?s=heatwave",
        ...
        request.cookies = {
            "_ga": "GA1.1.418721115.1742268410",
            "RBUUID": "sdkepiz",
            "personalize_sync": "",
            "syncTimeout": "1",
            "FCNEC": "%5B%5B%22AKsRol-oVv1QNogm-xxsyG-__HCa23NFDyFUAyFo_E4sNVLxKQNXZH4PfjMwx97vJBUAA69s_vVirtpREo2m-N38YbMlE2LojHvvb_ugwxoSroJHQMwl5n64JSidgiVPqdtSXzjNPqleCkEOSh9QRO3rdh6N54fcnQ%3D%3D%22%5D%5D",
            "_ga_FBFF3MGNFY": "GS1.1.1742268409.1.1.1742268424.45.0.1122307614"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://www.dailynewsegypt.com/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='entry-content rbct clearfix']//p/text()").extract())
        items.author = ''
