...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.sibconline.com.sb/"
            params = {
                "s": f"{keyword}",
                "paged": "1"
            }
            yield feapder.Request(url, params=params, method='GET', callback=self.parse_url, page=page,
                                  keyword=keyword,
                                  filter_repeat=True)
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.sibconline.com.sb/?s=cyclone",
        ...
        request.cookies = {
            ...
            "tk_r3d": "%22%22",
            "tk_lr": "%22%22",
            "_gid": "GA1.3.1118349291.1743035840",
            "_ga_5TE21QD4M0": "GS1.1.1743035839.1.1.1743035963.0.0.0",
            "_ga": "GA1.1.1526695242.1743035839"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        yield feapder.Request(url, params=params,  method='GET', callback=self.parse_url, page=current_page,
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='entry-body']//p/text()").extract())
        items.author = ''
