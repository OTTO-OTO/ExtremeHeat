...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Ireland' and language = '英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = "https://api.queryly.com/v4/search.aspx"
            params = {
                "queryly_key": "954cd8bb239245f9",
                "initialized": "1",
                "": "",
                "query": f"{keyword}",
                "endindex": "0",
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "referer": "https://www.irishtimes.com/",
    ...
    def parse_url(self, request, response):
        ...
        links = re.findall(r'"link":"(.*?)"', response.text)
        ...
        for item in links:
            ...
            items.article_url ="https://www.irishtimes.com" + item
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//p[@class='c-paragraph paywall']//text()").extract())

        items.author = ''
        items.pubtime = response.xpath("//div[@class='b-it-byline-block__date']/text()").extract_first()
        print(items)
        if items.content:
            yield items
