...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://corbeaunews-centrafrique.org/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        ...
        request.headers = {
            ...
            "priority": "u=1, i",
            "referer": "https://corbeaunews-centrafrique.org/?s=chaud",
    ...
    def parse_url(self, request, response):
        ...
        try:
            ...
            # 尝试多种XPath选择器提取新闻链接
            link_selectors = [
                "//div[@id='tdi_79']//h3/a/@href",
                "//h3/a/@href",
                "//article//a/@href",
                "//div[contains(@class, 'post')]//a/@href",
                "//a[contains(@href, 'corbeaunews-centrafrique.org')]/@href"
            ]
            ...
            for selector in link_selectors:
                ...
                if extracted_links:
                    ...
                    print(f"使用选择器 {selector} 成功提取到 {len(links)} 个链接")
                    break
        ...
        url = f"https://corbeaunews-centrafrique.org/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        try:
            ...
            # 尝试提取内容，使用多个选择器
            content_selectors = [
                "//div[@class='td-post-content tagdiv-type']//p/text()",
                "//article//p/text()",
            ...
            if not items.pubtime:
                pubtime = response.xpath("//meta[@property='article:published_time']/@content").extract_first()
