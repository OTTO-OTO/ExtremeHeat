...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Cote_DIvoire' and language='法语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.fratmat.info/loadMoreSearchArticleResults"
            data = {
                "limit": "10",
                "currentLoad_nb": "1",
                "query": f"{keyword}",
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "origin": "https://www.fratmat.info",
            "priority": "u=1, i",
            "referer": "https://www.fratmat.info/search/?is_necrologie_section=0&query=Temp%C3%A9rature+%C3%A9lev%C3%A9e",
    ...
    def parse_url(self, request, response):
        ...
        data = {
            "limit": "10",
            "currentLoad_nb": f"{current_page}",
            "query": f"{current_keyword}",
            "datefrom": "",
            "dateto": ""
        }
        yield feapder.Request(url, data=data, callback=self.parse_url, page=current_page,
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='body-desc']//text()").extract())
        items.author = ''
