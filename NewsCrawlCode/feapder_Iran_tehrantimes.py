...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.tehrantimes.com/page/search.xhtml"
            params = {
                "q": f"{keyword}",
                "a": "0",
                "alltp": "true",
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.tehrantimes.com/page/search.xhtml?q=Heavy+rain&a=0&alltp=true&allpl=true&pi=2&allsr=true&pageSize=10&allty=true",
        ...
        request.cookies = {
            "_clck": "15mhm5q%7C2%7Cftc%7C0%7C1868",
            "_clsk": "zzq2ye%7C1739261679160%7C4%7C1%7Cf.clarity.ms%2Fcollect"
        }
        return request
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='item-text']//p/text()").extract())
        items.author = ''
        items.pubtime = response.xpath("//div[@class='item-date half-left']/text()").extract_first()
        print(items)
        # if items.content:
        #     yield items
