...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Estonia' and language='英语'"""
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=1, i",
            "referer": "https://www.ena.et/web/eng/client",
            ...
            "x-csrf-token": "SjoNop9G",
            "x-pjax": "true",
            "x-requested-with": "XMLHttpRequest"
        }
        request.cookies = {
            "JSESSIONID": "C3672A4F5DDB3FAC2CA34ABD853B2AFA",
            "COOKIE_SUPPORT": "true",
            "GUEST_LANGUAGE_ID": "en_US",
            "LFR_SESSION_STATE_20101": "1743044884707"
        }
        return request
