...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.diariandorra.ad/search/1"
            params = {
                "query": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.diariandorra.ad/search/?query=Temperatures+altes",
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://www.diariandorra.ad/search/{current_page}"
        params = {
