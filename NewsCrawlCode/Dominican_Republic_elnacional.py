...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Dominican_Republic' and language = '西班牙语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = "https://elnacional.com.do/str-search/list.php"
            params = {
                "page": "0",
                "txtBuscar": f"{keyword}",
                "txtFecha": "0",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//h2/a/@href").extract()[:10]
