...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.hoy.com.py/ajax.php"
            params = {
                "action": "paginate",
                "paged": "1",
                "offset": "0",
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=1, i",
            "referer": "https://www.hoy.com.py/search/Temperatura+alta",
    ...
    def parse_url(self, request, response):
        ...
        html_str = response.json['output']
        # print(html_str)
        links = etree.HTML(html_str).xpath("//article/h3/a/@href")
