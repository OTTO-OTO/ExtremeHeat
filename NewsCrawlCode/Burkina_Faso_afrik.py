...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Burkina_Faso' and language='法语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.afrik.com/catastrophe-naturelle/page/1"
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.afrik.com/catastrophe-naturelle",
        ...
        request.cookies = {
            "_ga": "GA1.1.938137736.1737358769",
            "__gads": "ID=77494aaa60693eb4:T=1737358777:RT=1737358777:S=ALNI_MZI5Me6L0Cnlt2qcm5fj_2apIIV6g",
            "__gpi": "UID=00000ff32c59c5ce:T=1737358777:RT=1737358777:S=ALNI_MYUgd4Qm8uh_AjQHxvdEHWjrPRXfg",
            "__eoi": "ID=cebd053c56b6b3c4:T=1737358777:RT=1737358777:S=AA-AfjZ3p96EtvPzNoDfKjCzJDi2",
            "_ga_P04VXEK104": "GS1.1.1737358768.1.1.1737358864.24.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://www.afrik.com/catastrophe-naturelle/page/{current_page}"
