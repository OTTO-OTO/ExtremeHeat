...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.eyeradio.org/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//h1/a/@href").extract()
        ...
        url = f"https://www.eyeradio.org/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='articles-section']//p/text()").extract())
        items.author = ''
