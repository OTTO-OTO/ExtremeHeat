...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.sknis.gov.kn/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.sknis.gov.kn/page/3/?s=heavy+rain",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='jeg_block_container']//h3/a/@href").extract()
        ...
        url = f"https://www.sknis.gov.kn/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='content-inner ']//p/text()").extract())
        items.author = ''
        items.pubtime = ''
        print(items)
        # if items.content:
