...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Lesotho' and language = '英语'"""
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://lestimes.com/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='inner-post-entry entry-content']//p//text()").extract())
        items.author = ''
