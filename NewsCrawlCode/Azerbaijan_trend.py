...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Azerbaijan' and language='英语'"""
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=1, i",
            "referer": "https://en.trend.az/search?query=storm",
            "sec-ch-ua": "\"Not(A:Brand\";v=\"99\", \"Microsoft Edge\";v=\"133\", \"Chromium\";v=\"133\"",
            "sec-ch-ua-arch": "\"x86\"",
            "sec-ch-ua-bitness": "\"64\"",
            "sec-ch-ua-full-version": "\"133.0.3065.92\"",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//ul[@class='news-list with-images']/li/a/@href").extract()
        # print(links)
        ...
        yield feapder.Request(url, params=params,data=data, callback=self.parse_url, page=current_page, keyword=current_keyword)
