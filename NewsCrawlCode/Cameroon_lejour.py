...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Cameroon' and language='法语'"""
    ...
    def download_midware(self, request):
        ...
        request.cookies = {
            "_ga": "GA1.1.1359150020.1736837387",
            "pvc_visits[0]": "1736837749b11472",
            "_ga_YK67KXJKGN": "GS1.1.1736837387.1.1.1736837716.0.0.0"
        }
        return request
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='btArticleContent']//p/text()").extract())
        items.author = ''
