...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = "https://alwatwan.net/resultat.html"
            params = {
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "Referer": "https://alwatwan.net/resultat.html?simplesearch_offset=10&elementsearch=Temp%C3%A9rature",
    ...
    def parse_url(self, request, response):
        ...
        url = "https://alwatwan.net/resultat.html"
        params = {
            "simplesearch_offset": f"{current_page}",
            "elementsearch": f"{current_page}"
        }
