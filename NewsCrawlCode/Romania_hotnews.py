...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Romania' and language = '罗马尼亚语'"""
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://hotnews.ro/?s=temperatur%C4%83",
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://hotnews.ro/page/{current_page}"
        params = {
            "s": f"{current_keyword}"
        }
