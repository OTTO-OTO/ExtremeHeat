...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Iran'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://en.mehrnews.com/page/search.xhtml"
            params = {
                "dt": "",
                "q": f"{keyword}",
                "a": "0",
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://en.mehrnews.com/search?a=0&q=Heavy+rain&dr=all&df=&dt=&sort=date&pageSize=20",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//li[@class='news']//h3/a/@href").extract()
