...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Eritrea' and language = '英语'"""
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "Referer": "https://awate.com/?s=heavy+rain",
        ...
        request.cookies = {
            "__gads": "ID=23ad212c1d4649cd:T=1737428881:RT=1737428881:S=ALNI_MYqJnPbQAUD34Iq1oKZfAuqpUFrEg",
            "__gpi": "UID=00001002261a8a7c:T=1737428881:RT=1737428881:S=ALNI_MZDLLDs6MuMecJy5-zLcMgdtBG--Q",
            "__eoi": "ID=473ed43288aef37e:T=1737428881:RT=1737428881:S=AA-AfjZ0m5VrSa2-DBs6ef5XDGS3"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://awate.com/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
