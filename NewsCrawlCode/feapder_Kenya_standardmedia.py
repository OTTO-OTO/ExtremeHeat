...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            params = {
                ...
                "cx": "011965659370381653902:7awkdkhs2_y",
                "q": f"{keyword}",
                "safe": "off",
                "cse_tok": "AB-tC_6pd6eGYTdGNoHgC8TfUmHu:1740378795818",
                "sort": "",
                "exp": "cc,apo",
                "callback": "google.search.cse.api10029",
                "rurl": f"https://www.standardmedia.co.ke/search?q={keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "referer": "https://www.standardmedia.co.ke/",
        ...
        request.cookies = {
            ...
            "__Secure-3PSIDCC": "AKEyXzVLsXBqUu_xOotrlQqhpJsMkJoxbXZSUlVthAVOzd0TzDjNiEmLsE16YrqPMJ3cMaaF0GA"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        data = response.text.split("api10029(")[-1].split(");")[0]
        pattern = r'"url": "(.*?)"'
        ...
        params = {
            ...
            "exp": "cc,apo",
            "callback": "google.search.cse.api10029",
            "rurl": f"https://www.standardmedia.co.ke/search?q={current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='col-12 col-md-8']//p//text()").extract())
        items.author = ''
        items.pubtime = response.xpath("//meta[@name='site-live']/@content").extract_first()
        print(items)
        # if items.content:
        #     yield items
