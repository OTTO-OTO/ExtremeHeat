...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Mauritania' and language = '法语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://lecalame.info/"
            params = {
                "q": f"search/node/{keyword}",
                "page": "1"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://lecalame.info/?q=search/node/fortes%20pluies",
    ...
    def parse_url(self, request, response):
        ...
        url = "https://lecalame.info/"
        params = {
            "q": f"search/node/{current_keyword}",
            "page": f"{current_page}"
        }
