...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://api.uza.uz/api/v1/posts/search"
            params = {
                "page": "1",
                "per_page": "21",
                "q": f"{keyword}",
    ...
    def parse_url(self, request, response):
        ...
        for item in links:
            ...
            html = etree.HTML(item.get("content"))
    ...
    #     content = "".join(response.xpath("//div[@class='content-block']//p/text()").extract())
    #     items.content = content
    #     items.author = ''
    #     items.pubtime = ''
    #     print(items)
