...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Comoros' and language='法语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = "https://mail.lagazettedescomores.com/resultat-de-la-recherche.html"
            params = {
                "simplesearch_offset": "0",
                "elementsearch": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://mail.lagazettedescomores.com/resultat-de-la-recherche.html?simplesearch_offset=10&elementsearch=Temp%C3%A9rature+",
        ...
        request.cookies = {
            "PHPSESSID": "4d673084632ce647eca8fced0517094c"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = "https://mail.lagazettedescomores.com/resultat-de-la-recherche.html"
        params = {
            "simplesearch_offset": f"{current_page * 10}",
            "elementsearch": f"{current_keyword}"
        }
