...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Portugal' and language = '西班牙语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.publico.pt/api/list/search/"
            params = {
                "query": f"{keyword}",
                "start": "",
                "end": "",
    ...
    def parse_url(self, request, response):
        ...
        for item in links:
            ...
            items.article_url = item.get("fullUrl")
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='story__body']//p/text()").extract())
        items.author = ''
