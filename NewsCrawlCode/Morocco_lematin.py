...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Montenegro' and language = '法语'"""
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://lematin.ma/search?query=Cyclone+tropical",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='matin-search-widget  ']//a[@class='article-title']/@href").extract()
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath(
                "//div[@class='article-content content ']//p/text()").extract())
        items.author = ""
