...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Namibia' and language = '英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.thevillager.com.na/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.thevillager.com.na/?s=heavy+rain",
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://www.thevillager.com.na/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath(
                "//div[@class='sigle-post-content-area']//p//text()").extract())
        items.author = ""
