...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "Referer": "https://emtv.com.pg/?s=heavy+rain",
        ...
        request.cookies = {
            "wp_wpfileupload_6d697da2227e8f81d0159f3ad0d34735": "Z33kGkAytzKCXEBO44KkpyMmyftMYmCk",
            "_gid": "GA1.3.194725701.1737164779",
            "_ga_4H9YKSKYQ1": "GS1.1.1737164778.1.1.1737164811.0.0.0",
            "_ga": "GA1.1.310431885.1737164778"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='penci-archive__list_posts']//h2/a/@href").extract()
        ...
        url = f"https://emtv.com.pg/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
