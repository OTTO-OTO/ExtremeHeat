...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.fanabc.com/english/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "Referer": "https://www.fanabc.com/english/?s=heavy+rain",
        ...
        request.cookies = {
            "_ga_321233161": "GS1.1.1739177858.1.1.1739178059.0.0.0",
            "_ga": "GA1.2.341732182.1739177859",
            "_gid": "GA1.2.351524971.1739178061",
            "_gat": "1",
            "PHPSESSID": "sg5pte2p0epi6gtbrm4oa7f37f"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://www.fanabc.com/english/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
