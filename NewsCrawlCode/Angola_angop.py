...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Angola' and language='葡萄牙语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = f"https://www.angop.ao/edt/search/pgina1"
            params = {
                "search": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "Referer": "https://www.angop.ao/edt/search/pgina2?search=Quente",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='row']//h4/a[1]/@href").extract()[:9]
        ...
        url = f"https://www.angop.ao/edt/search/pgina{current_page}"
        params = {
