...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Tajikistan' and language='英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://eng.khovar.tj/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "Referer": "https://eng.khovar.tj/?s=heavy+rain",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='content-block main left']//h2/a/@href").extract()
        # print(links)
        ...
        url = f"https://eng.khovar.tj/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        content = "".join(response.xpath("//div[@class='paragraph-row']//p/text()").extract())
        items.content = content
        items.author = ''
        items.pubtime = response.xpath("//span[@class='meta']/text()").extract_first()
        print(items)
        if items.content:
            yield items
