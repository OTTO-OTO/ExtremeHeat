...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Venezuela' and language='西班牙语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.telesurtv.net/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def parse_url(self, request, response):
        ...
        data = response.xpath("//h2[@class='card__info__title']/a/@href").extract()
        if not data:
        ...
        url = f"https://www.telesurtv.net/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
