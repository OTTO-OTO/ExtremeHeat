...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Jordan' and language = '英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = f"https://jordantimes.com/search/site/{keyword}"
            params = {
                "page": "1"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://jordantimes.com/search/site/heavy%20rain",
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://jordantimes.com/search/site/{current_keyword}"
        params = {
            "page": f"{current_page}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='news-body']//p//text()").extract())
