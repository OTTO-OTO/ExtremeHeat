...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://api.nationthailand.com/api/search"
            params = {
                "q": f"{keyword}",
                "page": "1"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "origin": "https://www.nationthailand.com",
            "priority": "u=1, i",
            "referer": "https://www.nationthailand.com/",
    ...
    def parse_url(self, request, response):
        ...
        for item in links:
            ...
            items.article_url = "https://www.nationthailand.com" + item.get("link")
    ...
    def parse_detail(self, request, response):
        ...
        content = "".join(response.xpath("//div[@class='detail']//p/text()").extract())
