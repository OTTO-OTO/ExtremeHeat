...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Vanuatu' and language='英语'"""
    ...
    def download_midware(self, request):
        ...
        request.cookies = {
            "_ga": "GA1.1.555783508.1736748671",
            "pll_language": "bi",
            "_ga_SJ6J0DF7K9": "GS1.1.1736748670.1.1.1736748859.0.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='td_block_inner tdb-block-inner td-fix-index']//h3/a/@href").extract()
        print(links)
        # print(links)
        ...
        url = f"https://vbtc.vu/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        content = "".join(response.xpath("//div[@class='tdb-block-inner td-fix-index']//p/text()").extract())
