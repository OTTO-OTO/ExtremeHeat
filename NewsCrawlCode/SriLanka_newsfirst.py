...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Sri_Lanka' and language='英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = f"https://apienglish.newsfirst.lk/post/PostSearch/{keyword}/0/5"
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "origin": "https://english.newsfirst.lk",
            "priority": "u=1, i",
            "referer": "https://english.newsfirst.lk/",
    ...
    def parse_url(self, request, response):
        ...
        links = response.json["postResponseDto"]
        # print(links)
        ...
        for item in links:
            ...
            items.title = item.get("title").get("rendered")
            content = "".join(etree.HTML(item.get("content").get("rendered")).xpath("//p//text()"))
            items.article_url = "https://english.newsfirst.lk/" + item.get("post_url")
        ...
        url = f"https://apienglish.newsfirst.lk/post/PostSearch/{current_keyword}/{current_page}/5"
