...
class AirSpiderDemo(feapder.AirSpider):
    ...
    country = 'Bahrain'
    table = 'Bahrain_gdnlife'
    keywords = ["heavy rain"]

    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.gdnlife.com/Home/SearchList"
            data = {
                "SearchBy": "",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='post-content']/h2/a/@href").extract()
        ...
        for item in links:
            ...
            items.article_url = "https://www.gdnlife.com" + item
        ...
        # url = "https://www.tribune242.com/search/vertical/news.story/"
        # params = {
        #     "page": f"{current_page}",
        #     "q": f"{current_keyword}"
        # }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='post-content']//p/text()").extract())
        items.author = ''
        items.pubtime = response.xpath("//ul[@class='post-tags']/li[last()]/text()").extract_first()
        print(items)
        # if items.content:
        #     yield items
