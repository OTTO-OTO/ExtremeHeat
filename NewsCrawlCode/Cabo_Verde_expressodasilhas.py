...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Cabo_Verde' and language='西班牙语'"""
    ...
    def parse_detail(self, request, response):
        ...
        items.author = ''
        items.pubtime = json.loads(response.xpath("//script[@type='application/ld+json']/text()").extract_first()).get(
            "datePublished")
        print(items)
        if items.content:
            yield items
