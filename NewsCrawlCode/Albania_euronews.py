...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Albania' and language='英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            yield feapder.Request(url, data=data, params=params, callback=self.parse_url, page=page, method='POST',
                                  keyword=keyword,td_magic_token=td_magic_token,
                                  filter_repeat=True)
    ...
    def parse_url(self, request, response):
        ...
        data = {
            ...
            "td_filter_value": "",
            "td_user_action": "",
            "td_magic_token": f"{request.td_magic_token}"
        }
