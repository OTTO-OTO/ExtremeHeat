...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Mexico' and language = '西班牙语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.proceso.com.mx/noticias/buscar/"
            params = {
                "buscar": f"{keyword}",
                "p": "1"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.proceso.com.mx/noticias/buscar/?buscar=calor",
        ...
        request.cookies = {
            "_gid": "GA1.3.1953929356.1737092753",
            "_ga": "GA1.3.358189800.1737092753",
            "_gat": "1",
            "_ga_QBGCTQ3PJM": "GS1.1.1737092752.1.1.1737092864.48.0.1988931740"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@id='resultados']//h5/a/@href").extract()
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@id='cuerpo-nota']//p/text()").extract())
        items.author = ''
        items.pubtime = response.xpath("//div[@class='fecha']/text()").extract_first()
        print(items)
        if items.content:
            yield items
