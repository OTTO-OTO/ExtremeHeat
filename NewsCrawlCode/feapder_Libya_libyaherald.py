...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://libyaherald.com/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://libyaherald.com/?s=heavy+rain",
        ...
        request.cookies = {
            ...
            "sbjs_current_add": "fd%3D2025-01-23%2001%3A45%3A00%7C%7C%7Cep%3Dhttps%3A%2F%2Flibyaherald.com%2F%7C%7C%7Crf%3D%28none%29",
            "sbjs_first_add": "fd%3D2025-01-23%2001%3A45%3A00%7C%7C%7Cep%3Dhttps%3A%2F%2Flibyaherald.com%2F%7C%7C%7Crf%3D%28none%29",
            ...
            "_ga": "GA1.1.1216496499.1737596700",
            "paywall_product": "false",
            "sbjs_session": "pgs%3D2%7C%7C%7Ccpg%3Dhttps%3A%2F%2Flibyaherald.com%2F%3Fs%3Dheavy%2Brain",
            "_ga_PDHYXL6DZE": "GS1.1.1737596700.1.1.1737596769.0.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='jeg_posts jeg_load_more_flag']//h3/a/@href").extract()
        ...
        url = f"https://libyaherald.com/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
