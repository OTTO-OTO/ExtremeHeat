...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='South_Sudan' and language='英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.radiotamazuj.org/en/page/1"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.radiotamazuj.org/en?s=Flooding",
        ...
        request.cookies = {
            ...
            "_ga": "GA1.1.1691978039.1736479071",
            "pvc_visits[0]": "1736565460b217",
            "_ga_ZZB9F99Z2T": "GS1.1.1736479070.1.1.1736479089.0.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://www.radiotamazuj.org/en/page/{current_page}"
        params = {
            "s": f"{current_keyword}"
        }
