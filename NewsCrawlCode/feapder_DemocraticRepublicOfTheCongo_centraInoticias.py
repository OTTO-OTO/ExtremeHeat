...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            headers = {
                ...
                "priority": "u=0, i",
                "referer": "https://centralnoticias.gob.do/",
    ...
    def parse_url(self, request, response):
        ...
        try:
            ...
            # 尝试多种XPath选择器
            xpath_selectors = [
                "//div[@class='ts-row']//article//h2/a/@href",
                "//h2/a/@href",
                "//h3/a/@href",
                "//article/a/@href",
            ...
            for link in links:
                if link.startswith('http'):
                    # 只保留来自 centralnoticias.gob.do 的链接
                    if 'centralnoticias.gob.do' in link:
                        valid_links.append(link)
                elif link.startswith('/'):
                    full_url = 'https://centralnoticias.gob.do' + link
        ...
        url = f"https://centralnoticias.gob.do/page/{current_page}"
        ...
        headers = {
            ...
            "accept-language": "zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6",
            "priority": "u=0, i",
            "referer": f"https://centralnoticias.gob.do/page/{current_page-1}",
            "sec-ch-ua": f"\"Microsoft Edge\";v=\"{random.randint(130, 135)}\", \"Chromium\";v=\"{random.randint(130, 135)}\", \"Not_A Brand\";v=\"24\"",
            "sec-ch-ua-mobile": "?0",
            "sec-ch-ua-platform": "\"Windows\"",
            "sec-fetch-dest": "document",
    ...
    def parse_detail(self, request, response):
        try:
            ...
            # 尝试提取内容，使用多个选择器
            content_selectors = [
                "//div[@class='post-content cf entry-content content-spacious']//p//text()",
                "//article//p/text()",
