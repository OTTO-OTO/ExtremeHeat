...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://mbc.mw/?s=heavy+rain",
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://mbc.mw/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='penci-entry-content entry-content']//p/text()").extract())
