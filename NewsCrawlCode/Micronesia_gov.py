...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Micronesia' and language = '英语'"""
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://gov.fm/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@dir='auto']/text() | //div[@class='elementor-widget-container']//p/text()").extract())
        items.author = ''
