...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Saudi_Arabia' and language = '英语'"""
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.arabnews.com/search/site/heavy%20rain",
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://www.arabnews.com/search/site/{current_keyword}"
        params = {
            "page": f"{current_page}"
        }
