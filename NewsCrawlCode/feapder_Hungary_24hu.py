...
class AirSpiderDemo(feapder.AirSpider):
    ...
    table = 'Hungary_24hu'
    keywords = [
    "meleg", "szélsőséges meleg hullám", "magas hőmérséklet", "szélsőséges hőmérséklet",
    "meleg hullám esemény", "magas hőmérséklet növekedése", "magas hőmérséklet hatása",
    "erős meleg", "hőmérséklet növekedése", "meleg esemény", "hőmérséklet növekedése",
    "erős eső", "erős eső", "városszivárvány", "szélsőséges eső", "szárazság", "súlyos szárazság",
    "hosszú ideig tartó szárazság", "vízhiány", "áramszünet", "magas hőmérséklet miatt áramszünet",
    "meleg hullám miatt áramszünet", "magas hőmérséklet miatt áramszünet", "tűz", "magas hőmérséklet miatt tűz",
    "meleg tűz", "hőmérséklet miatt tűz", "magas hőmérséklet miatt tűz", "agrár hatás", "meleg hullám agrár",
    "termőkáros", "agrár meleg stressz", "hiányzás", "fényezés", "magas hőmérséklet miatt hiányzás",
    "magas hőmérséklet miatt fényezés", "szállítási hatás", "magas hőmérséklet miatt szállítás",
    "meleg hullám miatt szállítás", "hőmérséklet miatt szállítás", "ökológiai katasztrófa", "meleg katasztrófa",
    "magas hőmérséklet környezet", "meleg biológiai sokféleség hatása", "meleg hullám ökológia", "szennyezés",
    "magas hőmérséklet miatt szennyezés", "meleg szennyezés", "hőmérséklet miatt szennyezés", "korallfehérődés",
    "magas hőmérséklet miatt korall", "hőmérséklet miatt fehérődés korall"
]
