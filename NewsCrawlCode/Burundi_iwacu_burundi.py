...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Burundi' and language='法语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.iwacu-burundi.org/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=1, i",
            "referer": "https://www.iwacu-burundi.org/?s=Chaud+",
        ...
        request.cookies = {
            "cbxuseronline-cookie": "wpuseronlineguest-62453",
            "PHPSESSID": "9900ablpld14ntkn36hcrcfpul",
            "resolution": "1920",
            "_gid": "GA1.2.1195987462.1737336925",
            "_ga_9ZZMHN1D14": "GS1.1.1737336925.5.1.1737336973.0.0.0",
            "_ga": "GA1.2.1364848797.1734511814"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://www.iwacu-burundi.org/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.author = ''
        items.pubtime = response.xpath("//div[@class='infos']/text()[2]").extract_first()
        print(items)
        if items.content:
            yield items
