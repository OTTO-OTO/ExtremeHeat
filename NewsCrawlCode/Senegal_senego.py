...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Senegal' and language = '法语'"""
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://senego.com/page/{current_page}"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='article-detail-content123']//p//text()").extract())
        items.author = ""
