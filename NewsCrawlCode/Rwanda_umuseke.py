...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Rwanda' and language='卢旺达语'"""
    ...
    print(f"{table}创建成功<=================")
    keywords = db.find(f"select keywords_list from keywords where language = '卢旺达语' and country='{table}'", to_json=True)[0].get(
        "keywords_list")
    # keywords = ['storm']
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://umuseke.rw/?s=Ubwicanyi",
    ...
    def parse_url(self, request, response):
        ...
        url = f"https://umuseke.rw/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
