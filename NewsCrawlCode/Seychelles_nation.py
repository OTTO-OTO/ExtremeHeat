...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Seychelles' and language = '英语'"""
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://www.nation.sc/search"
            params = {
                "search_q": f"{keyword}",
                "page": "1"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "Referer": "https://www.nation.sc/search?search_q=heavy+rain",
        ...
        request.cookies = {
            "PHPSESSID": "b31uvqkksqg35ga06iugg5h055",
            "_gid": "GA1.2.874528430.1738897407",
            "_gat_gtag_UA_46202032_8": "1",
            "_ga_QJ00SLZDKV": "GS1.1.1738897406.1.1.1738897413.0.0.0",
            "_ga": "GA1.1.2014404292.1738897407"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='result']/p/a[1]/@href").extract()
