...
class AirSpiderDemo(feapder.AirSpider):
    ...
    country = 'Austria'
    table = 'Austria_diepresse'
    keywords = [
    "Hitze", "Extremhitzewelle", "hohe Temperatur", "extreme Temperatur", "Hitzewellenereignis",
    "Erhöhung der hohen Temperaturen", "Einfluss der hohen Temperaturen", "hohe Temperatur",
    "starke Hitze", "Temperaturanstieg", "Hitzeereignis", "Temperaturerhöhung", "starke Niederschläge",
    "starke Niederschläge", "Schauergedel", "extreme Niederschläge", "Dürre", "schwere Dürre",
    "langfristige Dürre", "Wassermangel", "Stromausfall", "Hitze-Stromausfall", "Hitzewelle-Stromausfall",
    "Stromausfall durch hohe Temperaturen", "Feuer", "Hitze-Feuer", "Hitzefeuer", "Temperatur-Feuer",
    "Feuer durch hohe Temperaturen", "Einfluss auf die Landwirtschaft", "Hitzewelle-Landwirtschaft",
    "Schäden an Pflanzen", "thermischer Stress in der Landwirtschaft", "Sauerstoffmangel", "Hitzschlag",
    "Hitzschlag", "Hitze-Sauerstoffmangel", "Hitze-Hitzschlag", "Einfluss auf den Verkehr", "Hitze-Verkehr",
    "Hitzewelle-Verkehr", "Temperatur-Verkehr", "ökologische Katastrophe", "Hitze-Katastrophe",
    "Hitze-Umgebung", "Einfluss der Hitze auf die biologische Vielfalt", "Hitzewelle-Ökologie",
    "Verschmutzung", "Hitze-Verschmutzung", "Hitze-Verschmutzung", "Temperatur-Verschmutzung",
    "Korallenbleiche", "Hitze-Korallenriff", "Temperatur-Bleiche der Korallen"
]
