...
class AirSpiderDemo(feapder.AirSpider):
    ...
    sql = """ select db_name from keywords where country='Argentina' and language='法语'"""
    ...
    def parse_url(self, request, response):
        ...
        data = response.text.split("results = JSON.parse(")[-1].split(");")[0]
        # print(data)
        ...
        for item in links:
            ...
            items.article_url ="https://www.lanacion.com.ar" + item
    ...
    def parse_detail(self, request, response):
        ...
        content = "".join(response.xpath("//p[@class='com-paragraph   --s']//text()").extract())
