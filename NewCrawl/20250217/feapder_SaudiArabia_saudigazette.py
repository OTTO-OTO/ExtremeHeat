...
class AirSpiderDemo(feapder.AirSpider):
    ...
    table = 'SaudiArabia_saudigazette'
    #英语
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = f"https://www.saudigazette.com.sa/search/{keyword}/1"
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.saudigazette.com.sa/search/heavy%20rain",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='title-widget-2']/a/@href").extract()
        ...
        url = f"https://www.saudigazette.com.sa/search/{current_keyword}/{current_page}"
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='article-body articleBody']//p//text()").extract())
        items.author = ""
