...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 0
            url = "https://api.pobjeda.me/v1/articles"
            params = {
                "additional_fields": "count",
                # "extended_fields": "image,featured_gallery.media.author,video_cover_image,category,authors.image",
                "limit": "10",
                "offset": "10",
                "order": "desc",
    ...
    def parse_url(self, request, response):
        ...
        links = response.json['data'].get("data")
        ...
        for item in links:
            ...
            content = etree.HTML(item.get("content")).xpath("//p/text()")
