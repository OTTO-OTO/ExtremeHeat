...
class AirSpiderDemo(feapder.AirSpider):
    ...
    country = 'Eswatini'
    table = 'Eswatini_independentnews'
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://independentnews.co.sz/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://independentnews.co.sz/?s=heat",
        ...
        request.cookies = {
            ...
            "PHPSESSID": "159a8db5d172089733bc60dfe139bef6",
            "_gid": "GA1.3.822700324.1737339685",
            "_gat": "1",
            "_gat_gtag_UA_162183464_1": "1",
            "__gads": "ID=0d3a703168c3b238:T=1735872349:RT=1737339670:S=ALNI_MaekBPzXJQ2yIUW3FQLTLjbmAf1Kg",
            "__gpi": "UID=00000fd1dc82bdda:T=1735872349:RT=1737339670:S=ALNI_MbAzG3cmcZ89gdY-ZE2WAMI1mWf7A",
            "__eoi": "ID=03f8e8a895bfbf69:T=1735872349:RT=1737339670:S=AA-Afjacow1-Hzx8iEwv5QDVrWty",
            "_ga_4N94XV723T": "GS1.1.1737339684.3.1.1737339713.31.0.0",
            "_ga": "GA1.3.677867047.1735872357",
            "FCNEC": "%5B%5B%22AKsRol8XoNKFZ-8DP3TWHH-Ax8vKhlzAClejIY6H1nKockXA5zTdSjlNRCmCgkp1cMngjhSoNhMt5q1jqaPZMKyWj3AAg3WMVCsEOtOKIgZZj6bwS-BNGgQqI_gxB9pLqxugRujJV1zk6Mye53vVVsMedA3kPe7ThA%3D%3D%22%5D%5D"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='jeg_posts jeg_load_more_flag']//h3[@class='jeg_post_title']/a/@href").extract()
        print(links)
        ...
        url = f"https://independentnews.co.sz/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
