...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://bntnews.bg/search?q=%D0%B5%D0%BA%D1%81%D1%82%D1%80%D0%B5%D0%BC%D0%BD%D0%B8+&page=2",
        ...
        request.cookies = {
            "BNTSESSID": "ukzYy43AZQd6aLC7g8dpQ-D9%2CUHTnUGU",
            "cookiesession1": "678A3E0FAFBCA29215C183B25586AE32",
            "_ga": "GA1.1.1551582026.1737357155",
            "_gcl_au": "1.1.937556293.1737357155",
            "_clck": "16dbq7z%7C2%7Cfsq%7C0%7C1846",
            "_ga_V1VRKR2BY0": "GS1.1.1737357155.1.1.1737357803.60.0.0"
        }
        return request
    ...
    def parse_url(self, request, response):
        ...
        links = html.xpath("//div[@class='news-wrap-view']//a/@href")
        print(links)
