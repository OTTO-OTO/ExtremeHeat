...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            params = {
                ...
                "cx": "018012794629681752438:xbwt7vebspo",
                "q": f"{keyword}",
                "safe": "off",
                "cse_tok": "AB-tC_7MtHqCA0w_5hOOKPAJXO9x:1739600085647",
                "sort": "date",
                "exp": "cc",
                "callback": "google.search.cse.api4277",
                "rurl": f"https://www.independent.com.mt/search?q={keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "referer": "https://www.independent.com.mt/",
    ...
    def parse_url(self, request, response):
        ...
        links = json.loads(response.text.split("api4277(")[-1].split(");")[0])["results"]
        ...
        params = {
            ...
            "exp": "cc",
            "callback": "google.search.cse.api4277",
            "rurl": f"https://www.independent.com.mt/search?q={current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(
            response.xpath("//div[@class='text-container']//p/text()").extract())
        items.author = ''
        items.pubtime = response.xpath("//span[@class='date-published']/text()").extract_first()
        print(items)
        if items.content:
            yield items
