...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            yield feapder.Request(url, params=params, method="GET", callback=self.parse_url, page=page, keyword=keyword, filter_repeat=True)
    ...
    def download_midware(self, request):
        ...
        request.headers = {
            ...
            "priority": "u=0, i",
            "referer": "https://www.lostiempos.com/hemeroteca",
    ...
    def parse_detail(self, request, response):
        ...
        # 尝试提取发布时间
        pubtime = response.xpath("//div[@class='date-publish']/text()").extract_first()
        if not pubtime:
