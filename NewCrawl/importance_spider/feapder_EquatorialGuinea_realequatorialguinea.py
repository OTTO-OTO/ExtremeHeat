...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            page = 1
            url = "https://realequatorialguinea.com/page/1/"
            params = {
                "s": f"{keyword}"
            }
    ...
    def download_midware(self, request):
        request.headers = {
            ...
            "Referer": "https://realequatorialguinea.com/?s=calor",
    ...
    def parse_url(self, request, response):
        ...
        links = response.xpath("//div[@class='wpb_wrapper']//h3[@class='entry-title td-module-title']/a/@href").extract()[:10]
        ...
        url = f"https://realequatorialguinea.com/page/{current_page}/"
        params = {
            "s": f"{current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='td_block_wrap tdb_single_content tdi_141 td-pb-border-top td_block_template_5 td-post-content tagdiv-type']//p/text()").extract()).strip()
        items.author = ''
