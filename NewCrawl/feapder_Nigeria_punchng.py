...
class AirSpiderDemo(feapder.AirSpider):
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            "cx": "382df21fb8880078b",
                "q": f"{keyword}",
                "safe": "active",
                "cse_tok": "AB-tC_7lhYDGZM8o0_ybyQPEmjlw:1740627107956",
                "lr": "",
                "cr": "",
                "gl": "",
                "filter": "0",
                ...
                "as_sitesearch": "",
                "exp": "cc,apo",
                "callback": "google.search.cse.api14281",
                "rurl": f"https://punchng.com/search-page/?q={keyword}"
            }
    ...
    def parse_url(self, request, response):
        ...
        data = response.text.split("api14281(")[-1].split(");")[0]
        # print(data)
        ...
        for item in links:
            ...
            items.pubtime = item.get("richSnippet").get("metatags").get("articlePublishedTime")
        ...
        params = {
            ...
            "exp": "cc,apo",
            "callback": "google.search.cse.api14281",
            "rurl": f"https://punchng.com/search-page/?q={current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='post-content article-content']//p/text()| //div[@class='post-content']//p/text()").extract())
        items.author = ''
        # items.pubtime = ''
        print(items)
        if items.content:
