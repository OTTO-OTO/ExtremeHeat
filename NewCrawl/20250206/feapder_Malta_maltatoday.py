...
class AirSpiderDemo(feapder.AirSpider):
    ...
    table = 'Malta'
    #英语
    keywords = ["heatwave", "Extreme heatwave", "High temperature", "Extreme temperature", "Heatwave event",
    ...
    def start_requests(self):
        for keyword in self.keywords:
            ...
            params = {
                ...
                "cx": "014662895183893003337:smjreugceve",
                "q": f"{keyword}",
                "safe": "off",
                "cse_tok": "AB-tC_4Dv6t0OmfUEoK6ndVjB3Lw:1738803096271",
                "sort": "",
                "exp": "cc,apo",
                "callback": "google.search.cse.api3299",
                "rurl": f"https://www.maltatoday.com.mt/search-mt/?q={keyword}"
            }
    ...
    def parse_url(self, request, response):
        ...
        links = json.loads(response.text.split("api3299(")[-1].split(");")[0])['results']
        ...
        params = {
            ...
            "exp": "cc,apo",
            "callback": "google.search.cse.api3299",
            "rurl": f"https://www.maltatoday.com.mt/search-mt/?q={current_keyword}"
        }
    ...
    def parse_detail(self, request, response):
        ...
        items.content = "".join(response.xpath("//div[@class='content content-news']//p/text()").extract())
        items.author = ''
        items.pubtime = ''
        print(items)
        # if items.content:
